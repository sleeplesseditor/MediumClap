...
import CompoundComponentClap from '../../components/MediumClap/CompoundComponentClap';
  ...
  return (
    <React.Fragment>
      ...
      <div className="clap-message">
        <p>
          Inspect the <a className="clap-message-link" href="https://github.com/sleeplesseditor/MediumClap/blob/master/src/components/MediumClap/CompoundComponentClap.jsx">code</a> to see how each version of the component works!
        </p>
      </div>
    </React.Fragment>
  )
