...
import StateReducerClap from '../../components/MediumClap/StateReducerClap';

const StateInitializerPage = () => {
  return (
    <React.Fragment>
      <h1 className="clap-heading">State Reducer Page</h1>
      ...
      <div className="clap-message">
        <p>
          Inspect the <a className="clap-message-link" href="https://github.com/sleeplesseditor/MediumClap/blob/master/src/components/MediumClap/StateReducerClap.jsx">code</a> to see how each version of the component works!
        </p>
      </div>
    </React.Fragment>
  )
